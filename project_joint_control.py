...
objectId1 = p.loadURDF("Data/random_urdfs/156/156.urdf", [1.1, 0, 0.125], p.getQuaternionFromEuler([0, 0, 1.56]))
text_paths = 'C:/Users/josho/Desktop/SCHOOL WORK/SPRING 20/AI in robotics/final project/Project 2/Data/dtd/images/braided/braided_0002.jpg'
text_id = p.loadTexture(text_paths)
p.changeVisualShape(objectId1, -1, textureUniqueId=text_id)

objectId3 = p.loadURDF("Data/random_urdfs/155/155.urdf", [1.2, 0.1, 0], p.getQuaternionFromEuler([0, 0, 1.56]))
text_paths3 = 'C:/Users/josho/Desktop/SCHOOL WORK/SPRING 20/AI in robotics/final project/Project 2/Data/dtd/images/bumpy/bumpy_0014.jpg'
...
# ll = [-3.0503, -5.1477, -3.8183, -3.0514, -3.0514, -2.9842, -2.9842, -4.7104, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.1 7, 0.17, 0.17, 0.17, 0.85, 0.34, 0.17]
